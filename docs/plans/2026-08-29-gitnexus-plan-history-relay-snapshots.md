...
- enforce daemon-global resource bounds and a production-equivalent market-interference gate.
...
implementation_context:
  ...
  acceptance_criteria:
    ...
    - "Feature, migration, rollback, and production-equivalent interference gates pass."
  ...
  assumptions:
    ...
    - "Same-process OOM/abort coupling is accepted subject to resource and interference gates."
  open_questions:
...
- Deferred follow-up: a relay-managed internal worker process if same-process OOM/abort coupling becomes unacceptable.
...
- Feature isolation, migration, rollback, full focused test suite, formatting, clippy, docs, graph change detection, and production-equivalent interference benchmark all pass.
