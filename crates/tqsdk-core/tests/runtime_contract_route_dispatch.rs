    ...
    assert_eq!(
        ...
        vec![
            OutboundDispatch {
                ...
                account_id: None,
                request: tqsdk_core::OutboundRequest::Transport(tqsdk_core::OutboundFrame::Text(
            ...
            OutboundDispatch {
                ...
                account_id: None,
                request: tqsdk_core::OutboundRequest::Http(tqsdk_core::HttpRequest {
    ...
    run_on_tokio(async {
        ...
        assert_eq!(
            ...
            vec![OutboundDispatch {
                ...
                account_id: None,
                request: tqsdk_core::OutboundRequest::Replay(tqsdk_core::ReplayRequest {
                    action: "step"
                },),
            }]
        );
        assert_eq!(
            ...
            vec![OutboundDispatch {
                ...
                account_id: None,
                request: tqsdk_core::OutboundRequest::Internal(tqsdk_core::InternalRequest {
                    label: "refresh-auth",
                },),
            }]
        );
