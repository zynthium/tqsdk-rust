...
| `TQSDK_RELAY_FUTURES_SYMBOLS_FILE` | empty | File containing futures symbols, one per line or comma-separated. Use this for all-futures universes. Mutually exclusive with `TQSDK_RELAY_FUTURES_SYMBOLS`. |
