...
pub struct MetricsSnapshot {
    ...
    pub ticks_ingested: u64,
    pub market_cache_symbols: usize,
    pub market_cache_retained_bytes: usize,
    pub market_cache_max_symbols: usize,
    pub market_cache_max_retained_bytes: usize,
    pub market_cache_evicted_symbols: u64,
    pub market_cache_admission_drops: u64,
    pub rolling_cache_source_epoch: u64,
    pub rolling_cache_enqueued_revision: u64,
    pub rolling_cache_durable_revision: u64,
    pub rolling_cache_discontinuities: u64,
    pub rolling_cache_degraded: bool,
